 ...
 * @endcode
 */
$settings['hash_salt'] = 'i1njIBYAtrui_P9P4RoA3-v-pSHhjHeiBCMjEbFmy2JI_GQcKAQNCpNbgM36xQLoPYPhWoIexQ';
...
if (file_exists('/var/www/site-php/erpw/erpw-settings.inc')) {
  require('/var/www/site-php/erpw/erpw-settings.inc');
}
