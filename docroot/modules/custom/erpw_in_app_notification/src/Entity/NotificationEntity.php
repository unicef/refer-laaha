 ...
 *     "list_builder" = "Drupal\erpw_in_app_notification\NotificationEntityListBuilder",
 *     "views_data" = "Drupal\erpw_in_app_notification\Entity\NotificationEntityViewsData",
 *
 *     "form" = {
 *       "default" = "Drupal\erpw_in_app_notification\Form\NotificationEntityForm",
 *       "add" = "Drupal\erpw_in_app_notification\Form\NotificationEntityForm",
 *       "edit" = "Drupal\erpw_in_app_notification\Form\NotificationEntityForm",
 *       "delete" = "Drupal\erpw_in_app_notification\Form\NotificationEntityDeleteForm",
 *     },
 *     "route_provider" = {
 *       "html" = "Drupal\erpw_in_app_notification\NotificationEntityHtmlRouteProvider",
 *     },
 *     "access" = "Drupal\erpw_in_app_notification\NotificationEntityAccessControlHandler",
 *   },
...
class NotificationEntity extends ContentEntityBase implements NotificationEntityInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['name'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Name'))
      ->setDescription(t('The name of the Notification entity entity.'))
      ->setSettings([
        'max_length' => 50,
        'text_processing' => 0,
      ])
    ...
    $fields['status']->setDescription(t('A boolean indicating whether the Notification entity is published.'))
      ->setDisplayOptions('form', [
