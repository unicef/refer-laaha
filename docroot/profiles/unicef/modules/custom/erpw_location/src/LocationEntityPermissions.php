...
class LocationEntityPermissions {
   ...
   *
   * @return array
   *   The LocationEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (LocationEntity::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\erpw_location\Entity\LocationEntity $type
   *   The LocationEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(LocationEntity $type) {
    $type_id = $type->id();
