...
class HeaderResponse implements EventSubscriberInterface {
  ...
  public function onRespond(ResponseEvent $event) {
    ...
    $response->headers->set("X-Frame-Options", "ALLOW-FROM https://dev.virtualsafespace.net https://dev.iq.virtualsafespace.net https://dev.ec.virtualsafespace.net " . $event->getRequest()->getHost());
