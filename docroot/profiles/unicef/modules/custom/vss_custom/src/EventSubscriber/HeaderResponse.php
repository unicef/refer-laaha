...
class HeaderResponse implements EventSubscriberInterface {
  ...
  public function onRespond(ResponseEvent $event) {
    ...
    $response->headers->set("X-Frame-Options", "ALLOW-FROM dev.virtualsafespace.net dev.iq.virtualsafespace.net dev.ec.virtualsafespace.net " . $event->getRequest()->getHost());
    ...
    $csp .= " img-src 'self' data: http://stage.virtualsafespace.net http://stage.iq.virtualsafespace.net http://stage.ec.virtualsafespace.net http://dev.virtualsafespace.net http://dev.iq.virtualsafespace.net http://dev.ec.virtualsafespace.net  https://iq.virtualsafespace.net https://ec.virtualsafespace.net https://virtualsafespace.net https://www.googletagmanager.com https://www.google-analytics.com https://h5p.org https://www.gstatic.com https://www.youtube.com https://www.vimeo.com  https://i.ytimg.com;";

    $csp .= " style-src 'self' 'unsafe-inline' 'unsafe-eval' http://stage.virtualsafespace.net http://stage.iq.virtualsafespace.net http://stage.ec.virtualsafespace.net http://dev.virtualsafespace.net http://dev.iq.virtualsafespace.net http://dev.ec.virtualsafespace.net  https://iq.virtualsafespace.net https://ec.virtualsafespace.net https://virtualsafespace.net https://fonts.googleapis.com *.virtualsafespac e.net https://translate.googleapis.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://www.youtube.com https://www.vimeo.com https://i.ytimg.com;";

    $csp .= " font-src 'self' data: http://stage.virtualsafespace.net http://stage.iq.virtualsafespace.net http://stage.ec.virtualsafespace.net http://dev.virtualsafespace.net http://dev.iq.virtualsafespace.net http://dev.ec.virtualsafespace.net  https://iq.virtualsafespace.net https://ec.virtualsafespace.net https://virtualsafespace.net https://themes.googleusercontent.com https://fonts.gstatic.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com *.virtualsafespace.net https://www.youtube.com https://www.vimeo.com https://i.ytimg.com;";
