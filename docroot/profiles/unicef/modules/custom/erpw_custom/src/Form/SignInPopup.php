...
class SignInPopup extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['welcome_message'] = [
      ...
      '#suffix' => '</div>',
      '#markup' => $this->t('If you haven’t registered or signed in, you can either click on sign in below or go to <b>menu</b><span class="menu-icon"></span> to sign in or register later.'),
    ];
