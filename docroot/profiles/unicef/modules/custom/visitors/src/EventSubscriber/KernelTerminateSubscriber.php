...
class KernelTerminateSubscriber implements EventSubscriberInterface {
  ...
  public function onTerminate(PostResponseEvent $event) {
    ...
    if ($user->isAnonymous() && (strpos(Url::fromRoute('<current>')->toString(), 'user') == '' && strpos(Url::fromRoute('<current>')->toString(), 'modal') == '' && strpos(Url::fromRoute('<current>')->toString(), 'autocomplete') == ''  && strpos(Url::fromRoute('<current>')->toString(), 'nodeviewcount') == '')) {
